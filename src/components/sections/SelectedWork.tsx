...
const allProjects = [
  ...
  },
  {
    ...
    description: "Red and blue team in one box: 217 regex rules + a fine-tuned DistilBERT classifier stop prompt injection and jailbreaks. Evaluated against 150 unseen prompts (including 0-days) with 76% accuracy. I led the team and built the full backend.",
    icon: Shield,
    chips: ["FastAPI", "DistilBERT", "Groq API", "Docker"],
